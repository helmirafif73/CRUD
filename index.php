...
<body>
	<div class="w3-top">
		<div class="w3-bar w3-transparant w3-card ">
			...
			<a href="#product" class="w3-bar-item w3-button w3-padding-large w3-right">PRODUCT</a>
	...
	<div class="w3-content" style="max-width:2000px;margin-top:46px">
		...
		<!-- isi product -->
		<div class="w3-container w3-content w3-padding-32 style="max-width:800px" id="product">
			<h2 class="w3-wide w3-center">PRODUCT</h2>
			<div class="w3-row w3-padding-32">
			<div class="w3-col m6 w3-large w3-margin-bottom">
					<img src="../tugasakhir/profil1.jpg" alt="Pura Smart Technology" style="width:100%" class="w3-hover-opacity">
					<div class="w3-row row w3-black">
						<p><b>Pura Smart Technology</b></p>
					</div>
			</div>
			</div>
